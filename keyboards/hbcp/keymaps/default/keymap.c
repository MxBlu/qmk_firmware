...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  /*K000,     K001,    K002,   K003,   K004,   K005,   K006,   K007,   K008,   K009,    K010,     K011,    K012,             K014,    K015,    K016,    K017, \
    ...
    KC_LCTL,  KC_LGUI,                         KC_SPC,                                  KC_RALT,    KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT, KC_P0,   KC_PDOT, KC_PENT
  ...
  [1] = LAYOUT_wkl(
    ...
    KC_MUTE,  KC_VOLU, KC_VOLD,KC_MNXT,KC_MPRV, KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS,KC_TRNS, KC_TRNS,
    KC_CAPS,  KC_MPLY, KC_MPLY,KC_MSTP,KC_TRNS, KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS, KC_TRNS,  KC_TRNS,          KC_TRNS,  KC_TRNS, KC_TRNS,KC_TRNS, KC_TRNS,
