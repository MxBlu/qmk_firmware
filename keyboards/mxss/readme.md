...
### Important Note:
**This PCB supports the VIA configurator, and this is the recommended way to configure the keymap on this keyboard. Use `make mxss:via` to generate a hex for use with VIA.**
